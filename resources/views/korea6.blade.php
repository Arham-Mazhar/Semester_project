            ...
            <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
                <div class="row">
                    <div class="col-lg-2 order-lg-1 order-2">
                        <ul class="image_list">
                            <li data-image=""><img src="/KoreaImages/6.1.jpg" alt=""></li>
                            <li data-image=""><img src="/KoreaImages/6.2.jpg" alt=""></li>
                            <li data-image=""><img src="/KoreaImages/6.3.jpg" alt=""></li>
                        </ul>
                    </div>
                    <div class="col-lg-4 order-lg-2 order-1">
                        <div class="image_selected"><img src="/KoreaImages/6.4.jpg" alt=""></div>
                    </div>
