            ...
            <div class="container-fluid" style=" background-color: #fff; padding: 11px;">
                <div class="row">
                    <div class="col-lg-2 order-lg-1 order-2">
                        <ul class="image_list">
                            <li data-image="/UsaImages/pic2.webp"><img src="/UsaImages/pic2.webp" alt=""></li>
                            <li data-image="/UsaImages/pic3.webp"><img src="/UsaImages/pic3.webp" alt=""></li>
                            <li data-image="/UsaImages/pic4.webp"><img src="/UsaImages/pic4.webp" alt=""></li>
                        </ul>
                    </div>
                    <div class="col-lg-4 order-lg-2 order-1">
                        <div class="image_selected"><img src="/UsaImages/pic1.webp" alt=""></div>
                    </div>
                        ...
                        <div class="product_description">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="USA-List">USA List</a></li>
                                    <li class="breadcrumb-item active">Place To Stay</li>
                                </ol>
                            </nav>
                            <div class="product_name">Royal Lahaina Resort & Bungalows(3-star resort)</div>
...
<div>
  <a href="Booking"><button class="btn btn-primary">Book Your Trip</button></a>
</div>
