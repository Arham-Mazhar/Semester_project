...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="flex-container">
        <div>
          <a href="Royal-resort"><img src="/UsaImages/6130aa6a3c000671348962_main.jpeg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5><strong>Royal Resort & Bangalows</strong></h5>
            <h6>Maui,United States</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 50%;"></div>
      ...
      <div class="flex-container">
        <div>
          <a href="Royal-resort"><img src="/UsaImages/60dcfd08e2a5b578226778_main.jpg" alt=""></a>
          <div class="usa">
            <p>5-start resort</p>
            <h5 style="margin-left:4%;"><strong>Comblo Resort & Bangalows</strong></h5>
            <h6 style="margin-left:-14%;">San Francisco,United States</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 35%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Royal-resort">
              <button>See More</button>
            </a>
      ...
      <div class="flex-container">
        <div>
          <a href="Royal-resort"><img src="/UsaImages/3.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5><strong>Royal Resort & Bangalows</strong></h5>
            <h6 style="margin-left:-24%;">Chicago,United States</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 45%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Royal-resort">
              <button>See More</button>
            </a>
      ...
      <div class="flex-container">
        <div>
          <a href="Royal-resort"><img src="/UsaImages/4.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5 style="margin-left:10% "><strong>Richmond Resort & Bangalows</strong></h5>
            <h6 style="margin-left:-16% ">New Orleans,United States</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 37%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Royal-resort">
              <button>See More</button>
            </a>
      ...
      <div class="flex-container">
        <div>
          <a href="Royal-resort"><img src="/UsaImages/5.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5><strong>Glaxy Resort & Bangalows</strong></h5>
            <h6 style="margin-left: -26%;">Austin,United States</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 47%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Royal-resort">
              <button>See More</button>
            </a>
      ...
      <div class="flex-container">
        <div>
          <a href="Royal-resort"><img src="/UsaImages/6.jpg" alt=""></a>
          <div class="usa">
            <p>5-start resort</p>
            <h5 style="margin-left: 4%;"><strong>Superia Resort & Bangalows</strong></h5>
            <h6 style="    margin-left: -20%;">Las Vegas,United States</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 41%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Royal-resort">
              <button>See More</button>
            </a>
