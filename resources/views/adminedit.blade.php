...
<div id="wrapper">
    ...
    <div class="container">
        <h1>Please Update Your Product</h1>
        <form action="/update1" method="POST">
            {{-- @method("PUT") --}}
            @csrf
            <input type="hidden" name="id" value="{{$data['id']}}">
            <p>Traveler Name</p>
            <input name="name" type="text" value="{{$data->pname}}"  placeholder="Enter Product Name">
            <p>Traverler Email</p>
            <input type="email" name="email" value="{{$data->pprice}}" placeholder="Enter Product Price" >
            <p>Traveler Password</p>
            <input type="password" name="password" value="{{$data->pprice}}" placeholder="Enter Product Price" >
            <p>Traveler DOB</p>
            <input type="date" name="DOB" value="{{$data->pprice}}" placeholder="Enter Product Price" >
            <br><br>
