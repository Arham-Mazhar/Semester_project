...
<div id="wrapper">
    ...
    <div class="container">
        ...
        <form action="/update1" method="POST">
            ...
            <p>Traveler Name</p>
            <input name="name" type="text" value="{{$data->pname}}"  placeholder="Enter Name">
            <p>Traverler Email</p>
            <input type="email" name="email" value="{{$data->pprice}}" placeholder="Enter Email" >
            <p>Traveler Password</p>
            <input type="password" name="password" value="{{$data->pprice}}" placeholder="Enter Password" >
            <p>Traveler DOB</p>
            <input type="date" name="DOB" value="{{$data->pprice}}" placeholder="Enter DOB" >
            <br><br>
