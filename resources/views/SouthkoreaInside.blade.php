...
<body>
    <nav class="navbar navbar-expand-lg bg-light">
      ...
      <div class="flex-container">
        <div>
          <a href="JooOk_Restaurant"><img src="/KoreaImages/1.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5 ><strong style="margin-left: -19%">Joo Ok Restaurant</strong></h5>
            <h6 style="-33%">KR, South Korea</h6>
            <div style="border-top: 2px solid #757575; margin-left: 20%; margin-top: -2%; margin-bottom: 2%;margin-right: 53%;"></div>
      ...
      <div class="flex-container">
        <div>
          <a href="Jungsik_Seoul"><img src="/KoreaImages/2.jpg" alt=""></a>
          <div class="usa">
            <p>5-start resort</p>
            <h5 style="margin-left:-29%;"><strong>Jungsik Seoul</strong></h5>
            <h6 style="margin-left:-29%;"> Seoul, South Korea</h6>
            <div style="border-top: 2px solid #757575; margin-left: 20%; margin-top: -2%; margin-bottom: 2%;margin-right: 49%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
      ...
      <div class="flex-container">
        <div>
          <a href="La_Yeon"><img src="/KoreaImages/3.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5 style="    margin-left: -41%;"><strong>La Yeon</strong></h5>
            <h6 style="margin-left:-29%;">Seoul, South Korea</h6>
            <div style="border-top: 2px solid #757575; margin-left: 20%; margin-top: -2%; margin-bottom: 2%;margin-right: 49%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="La_Yeon">
      ...
      <div class="flex-container">
        <div>
          <a href="Mugunghwa"><img src="/KoreaImages/4.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5 style="margin-left:-32% "><strong>Mugunghwa</strong></h5>
            <h6 style="margin-left:-28% ">Seoul, South Korea</h6>
            <div style="border-top: 2px solid #757575; margin-left: 21%; margin-top: -2%; margin-bottom: 2%;margin-right: 49%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Mugunghwa">
              <button>See More</button>
            </a>
      ...
      <div class="flex-container">
        <div>
          <a href="Yookssam_Naengmyeon"><img src="/KoreaImages/5.jpg" alt=""></a>
          <div class="usa">
            <p>3-start resort</p>
            <h5 style="margin-left: -6%"><strong>Yookssam Naengmyeon</strong></h5>
            <h6 style="margin-left: -26%;"> Daegu, South Korea</h6>
      ...
      <div class="flex-container">
        <div>
          <a href="Hankook_Jib"><img src="/KoreaImages/6.jpg" alt=""></a>
          <div class="usa">
            <p>5-start resort</p>
            <h5 style="margin-left: -32%;"><strong>Hankook Jib</strong></h5>
            <h6 style="    margin-left: -20%;"> Jeollabuk-do, South Korea</h6>
            <div style="border-top: 2px solid #757575; margin-left: 19%; margin-top: -2%; margin-bottom: 2%;margin-right: 39%;"></div>
            <h4><small>Free wifi acess, Free swiming pool, Fitness center</small></h4>
            <a href="Hankook_Jib">
              <button>See More</button>
            </a>
