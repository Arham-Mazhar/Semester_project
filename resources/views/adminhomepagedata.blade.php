...
{{-- the display start from here --}}

<div class="flex-container" style="display: flex;justify-content:center;font-family:'Rubik Spray Paint', cursive;"><h1>HomePage List</h1></div>
<div class="container">
